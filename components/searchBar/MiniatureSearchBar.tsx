...
export function MiniatureSearchBar({
    ...
    return (
        <div
            ...
            <Search searchFilter={searchFilter} type={"figure"}/>
            <FactionSelect filterObject={factions} searchFilter={searchFilter} releaseWaveFilter={releaseWaveFilter} factionFilter={factionFilter}/>
            <ReleaseWaveSelect filterObject={releaseWaves} searchFilter={searchFilter} factionFilter={factionFilter} releaseWaveFilter={releaseWaveFilter}/>
        </div>
    )
}
